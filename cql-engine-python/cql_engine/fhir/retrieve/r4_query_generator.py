"""R4-specific FHIR query generator."""
...
class R4FhirQueryGenerator(BaseFhirQueryGenerator):
    """FHIR query generator for R4 (HL7 FHIR version 4.0.1)."""
